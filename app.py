...
for fix in fixtures:
    ...
    if expected_corner == 0:
        ...
        st.warning(
            "⚠️ Corner Data မရသေးပါ - Rating မတွက်ပါ"
        )
